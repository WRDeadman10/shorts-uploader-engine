...
def build_script_specs() -> List[ScriptSpec]:
    youtube_options: List[OptionSpec] = [
        ...
        OptionSpec("meta_access_token", "Meta User Access Token", "text", "", "Your long-lived Meta User access token. The Page token and IG ID will be automatically fetched and cached.", "--meta-access-token"),
    ...
    meta_options: List[OptionSpec] = [
        ...
        OptionSpec("access_token", "Meta User Access Token", "text", "", "Your long-lived Meta User access token.", "--access-token"),
